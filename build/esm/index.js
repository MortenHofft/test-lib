...
var primaryOutline = function primaryOutline(theme) {
  return /*#__PURE__*/css("border-color:", theme.primary600, ";background:none;color:", theme.primary700, ";" + ("" ), "" );
};
...
var spinAround = keyframes(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(359deg);\n  }\n"])));
...
var Button = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  return jsx(Button$1, _extends({
    ...
    css: /*#__PURE__*/css(styles.button(theme), " ", classesToApply.map(function (x) {
      return styles[x](theme);
    }), ";" + ("" ), "" )
  }, props), truncate ? jsx("span", {
    style: truncateStyle
  }, children) : children);
});
...
var FilterButton = /*#__PURE__*/React.forwardRef(function (_ref3, ref) {
  ...
  }, isNegated && jsx(Button, _extends({}, props, {
    title: "Negated filter",
    appearance: "primary",
    onClick: onClick,
    loading: loading
  }), jsx("span", null, "Exclude")), jsx(Button, _extends({}, props, {
    style: {
      maxWidth: 400
    },
    title: title,
...
export { Button, ButtonGroup, FilterButton };
